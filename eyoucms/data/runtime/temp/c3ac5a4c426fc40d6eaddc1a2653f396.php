...
<div class="page" style="min-width:auto;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo U('Arctype/single_edit'); ?>" method="post">
        <!-- 常规选项 -->
