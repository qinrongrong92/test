<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/tools\index.htm";i:1545616313;s:66:"D:\wamp64\www\eyoucms\application\admin\template\public\layout.htm";i:1547521060;s:62:"D:\wamp64\www\eyoucms\application\admin\template\tools\bar.htm";i:1545615936;s:66:"D:\wamp64\www\eyoucms\application\admin\template\public\footer.htm";i:1545615936;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?php if(\think\Request::instance()->action() == 'index'): ?>javascript:void(0);<?php else: ?><?php echo U("Tools/index"); endif; ?>" class="tab <?php if(\think\Request::instance()->action() == 'index'): ?>current<?php endif; ?>"><span>数据备份</span></a></li>
                <li><a href="<?php if(in_array(\think\Request::instance()->action(), array('restore'))): ?>javascript:void(0);<?php else: ?><?php echo U("Tools/restore"); endif; ?>" class="tab <?php if(in_array(\think\Request::instance()->action(), array('restore'))): ?>current<?php endif; ?>"><span>数据还原</span></a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
    ...
    <div class="flexigrid">
        <div class="mDiv">
            <div class="ftitle">
                <h3>数据库表列表</h3>
                <h5>(共<?php echo $tableNum; ?>条记录，共计<?php echo $total; ?>)</h5>
            </div>
        ...
        <div class="bDiv" style="height: auto;">
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                <form  method="post" id="export-form" action="<?php echo U('Tools/export'); ?>">
