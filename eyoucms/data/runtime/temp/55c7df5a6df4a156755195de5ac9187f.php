<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"./application/admin/template/archives\index_archives.htm";i:1545616313;s:63:"E:\www\www\eyoucms\application\admin\template\public\layout.htm";i:1547521060;s:63:"E:\www\www\eyoucms\application\admin\template\public\footer.htm";i:1545615936;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="min-width:auto;">
    <div class="flexigrid" style="margin-top: 0px;">
        <div class="mDiv" style="padding: 5px 0px;">
            ...
            <form id="search_form" class="navbar-form form-inline" action="<?php echo U('Archives/index_archives'); ?>" method="get" onsubmit="layer_loading('正在处理');">
...
<!--                     <div class="sDiv2">  
                    ...
                    <div class="sDiv2">
                        <input type="button" class="btn" value="重置" onClick="window.location.href='<?php echo U('Archives/index_archives', array("typeid"=>\think\Request::instance()->param('typeid'))); ?>';">
                    </div>
                </div>
            </form>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="" style="width: 100%;">
                                <div class="tl" style="padding-left: 10px;">
                                    <?php if(!(empty($vo['litpic']) || (($vo['litpic'] instanceof \think\Collection || $vo['litpic'] instanceof \think\Paginator ) && $vo['litpic']->isEmpty()))): ?>
                                        <img src="/eyoucms/public/static/admin/images/pic.gif" onmouseover="layer_tips=layer.tips('<img src=<?php echo $vo['litpic']; ?> class=\'layer_tips_img\'>',this,{tips: [1, '#fff']});" onmouseout="layer.close(layer_tips);">&nbsp;
                                    <?php endif; if(is_check_access('Archives@edit') == '1'): ?>
                                    <a href="<?php echo U($channelRow[$vo['channel']]['ctl_name'].'/edit',array('id'=>$vo['aid'],'typeid'=>\think\Request::instance()->param('typeid'),'gourl'=>$gourl)); ?>" style="<?php if($vo['is_b'] == '1'): ?> font-weight: bold;<?php endif; ?>"><?php echo $vo['title']; ?></a>
                                    <?php else: ?>
                                    <?php echo $vo['title']; endif; ?>
                                </div>
                            </td>
                            <td class="">
                                <div class="w100 tc"><a href="<?php echo U('Archives/index_archives', array('typeid'=>$vo['typeid'])); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td>
                                <div class="tc w50">
                            ...
                            <td class="">
                                <div class="w180 tc">
                                    ...
                                    <a href="<?php echo U($channelRow[$vo['channel']]['ctl_name'].'/edit',array('id'=>$vo['aid'],'typeid'=>\think\Request::instance()->param('typeid'),'gourl'=>$gourl)); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                                    <?php endif; if(is_check_access('Archives@del') == '1'): ?>
                                    <a class="btn red"  href="javascript:void(0);" data-url="<?php echo U('Archives/del'); ?>" data-id="<?php echo $vo['aid']; ?>" onClick="delfun(this);"><i class="fa fa-trash-o"></i>删除</a>
                             ...
                             <td class="sort">
                                <div class="w60 tc">
                                    <?php if(is_check_access('Archives@edit') == '1'): ?>
                                    <input style="text-align: left;" type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'');" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onchange="changeTableVal('archives','aid','<?php echo $vo['aid']; ?>','sort_order',this);"  size="4"  value="<?php echo $vo['sort_order']; ?>" />
                                    <?php else: ?>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a onclick="batch_del(this, 'ids');" data-url="<?php echo U('Archives/del'); ?>">
                ...
                <div class="fbutton">
                    <a onclick="func_move(this, 'ids');" data-url="<?php echo U('Archives/move', array('typeid'=>\think\Request::instance()->param('typeid'))); ?>">
...
<script type="text/javascript">
    ...
    function quick_release()
    {
        ...
        layer.open({
            ...
            area: ['600px', '520px'],
            content: "<?php echo U('Archives/release', array('iframe'=>2)); ?>",
            success: function(layero, index){
                // var body = layer.getChildFrame('body', index);
                // var gourl = $('.curSelectedNode').attr('href');
                // if (!$.trim(gourl)) {
                //     gourl = "<?php echo U('Archives/index_archives'); ?>";
                // }
