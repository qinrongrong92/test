<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/article\add.htm";i:1545616313;s:63:"E:\www\www\eyoucms\application\admin\template\public\layout.htm";i:1547521060;s:68:"E:\www\www\eyoucms\application\admin\template\field\addonextitem.htm";i:1545616313;s:63:"E:\www\www\eyoucms\application\admin\template\public\footer.htm";i:1545615936;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="min-width:auto;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo U('Article/add'); ?>" method="post">
        <!-- 常规信息 -->
...
<script src="/eyoucms/public/static/admin/js/getting-started.js"></script> -->
        ...
        <div class="ncap-form-default tab_div_2" style="display:none;">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic">为空则系统自动构成，可以到 <a href="<?php echo U('Seo/index', array('inc_type'=>'seo')); ?>">SEO设置 - SEO基础</a> 中设置构成规则。</p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
        ...
        <div class="ncap-form-default tab_div_3" style="display:none;">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="<?php echo \think\Session::get('admin_info.pen_name'); ?>" name="author" id="author" class="input-txt">
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
