<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./application/admin/template/article\index.htm";i:1545616313;s:63:"E:\www\www\eyoucms\application\admin\template\public\layout.htm";i:1547521060;s:61:"E:\www\www\eyoucms\application\admin\template\article\bar.htm";i:1545616313;s:63:"E:\www\www\eyoucms\application\admin\template\public\footer.htm";i:1545615936;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="flexigrid">
                        ...
                        <tr>
                            ...
                            <td class="">
                                <div class="w180 tc">
                                    ...
                                    <a class="btn red"  href="javascript:void(0);" data-url="<?php echo url('Article/del'); ?>" data-id="<?php echo $vo['aid']; ?>" onClick="delfun(this);"><i class="fa fa-trash-o"></i>删除</a>
                                    <?php endif; ?>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a onclick="batch_del(this, 'ids');" data-url="<?php echo url('Article/del'); ?>">
