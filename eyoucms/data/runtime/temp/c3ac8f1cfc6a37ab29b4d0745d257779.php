<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:31:"./template/pc/\view_article.htm";i:1545616477;s:24:"./template/pc/header.htm";i:1545615936;s:22:"./template/pc/left.htm";i:1557373699;s:24:"./template/pc/footer.htm";i:1557564317;}*/ ?>
...
<script src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $_value = $tagGlobal->getGlobal("web_templets_pc"); echo $_value; ?>/skin/js/sdcms.hits.js"></script>
</head>
<body>
<!--页头开始-->
...
<div class="product sub_pro"> <div class="sub_pro01"> 
  ...
  <div class="product02">
    ...
    <div class="content">
      <div class="view">
        <h1 class="view-title"><?php echo $eyou['field']['title']; ?></h1>
        <div class="view-date">发布时间：<?php echo MyDate('Y-m-d H:i:s',$eyou['field']['add_time']); ?>　点击量：<span id="hits"><?php  $tagArcclick = new \think\template\taglib\eyou\TagArcclick; $_value = $tagArcclick->getArcclick("", ""); echo $_value; ?></span></div>
        <div class="bshare-custom view-share" ></div>
        <p><?php echo $eyou['field']['content']; ?></p>
      </div>
      <div class="page">
        <p> <?php  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $__LIST__ = $tagPrenext->getPrenext("pre");if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): if( empty($__LIST__) ) : echo htmlspecialchars_decode("&lt;a&gt;上一篇：暂无&lt;/a&gt;");else: $field = $__LIST__;$field["title"] = text_msubstr($field["title"], 0, 100, false);?> <a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>"> 上一篇 : <?php echo $field['title']; ?></a> <?php endif; else: echo htmlspecialchars_decode("&lt;a&gt;上一篇：暂无&lt;/a&gt;");endif; ?> </p>
        <p> <?php  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $__LIST__ = $tagPrenext->getPrenext("next");if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): if( empty($__LIST__) ) : echo htmlspecialchars_decode("&lt;a&gt;下一篇：暂无&lt;/a&gt;");else: $field = $__LIST__;$field["title"] = text_msubstr($field["title"], 0, 100, false);?> <a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>"> 下一篇: <?php echo $field['title']; ?></a> <?php endif; else: echo htmlspecialchars_decode("&lt;a&gt;下一篇：暂无&lt;/a&gt;");endif; ?> </p>
        <a href="<?php echo $eyou['field']['typeurl']; ?>" title="返回列表" class="back theme_color">返回列表</a> </div>
    </div>
    <!--文章内容结束--> 
  </div>
  <div class="clear"></div>
