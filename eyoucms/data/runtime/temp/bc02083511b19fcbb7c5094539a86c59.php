<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/index\index.htm";i:1547458018;s:64:"E:\www\www\eyoucms\application\admin\template\public\menubox.htm";i:1545615936;s:61:"E:\www\www\eyoucms\application\admin\template\public\left.htm";i:1545616313;}*/ ?>
<!doctype html>
<html>
<head>
...
<link rel="shortcut icon" type="image/x-icon" href="/eyoucms/favicon.ico" media="screen"/>
...
<script type="text/javascript" src="/eyoucms/public/static/admin/js/jquery.bgColorSelector.js"></script>
<script type="text/javascript" src="/eyoucms/public/static/admin/js/admincp.js?v=<?php echo $version; ?>"></script>
...
<script type="text/javascript" src="/eyoucms/public/static/admin/js/dialog/dialog.js" id="dialog_js"></script>
...
<div class="metcms_cont_left hidden-xs">
    <dl class="metlogo">
        ...
        <a href="<?php echo \think\Request::instance()->url(); ?>"><img src="/eyoucms/public/static/admin/images/logo_ey.png?v=<?php echo time(); ?>" alt="点击刷新" title="点击刷新"></a>
        <?php else: ?>
        <a href="<?php echo \think\Request::instance()->url(); ?>"><img src="/eyoucms/public/static/admin/images/logo.png?v=<?php echo time(); ?>" alt="点击刷新" title="点击刷新"></a>
        <?php endif; ?>
    </dl>
      ...
      <div class="wraper">
        ...
        <div class="admincp-header-r">
          <div class="manager">
              ...
              <em class="eyou_tool em_lang" data-expanded="close">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="shouquan">
                  <?php if(is_array($languages) || $languages instanceof \think\Collection || $languages instanceof \think\Paginator): $i = 0; $__LIST__ = $languages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <li class="met-tool-list text-center lang"><a class="liaojie" href="?lang=<?php echo $vo['mark']; ?>"><?php echo $vo['title']; ?></a></li>
                  <?php endforeach; endif; else: echo "" ;endif; ?>
                    <li class="met-tool-list text-center" id="addlang">
            ...
            <span class="avatar">
            <img alt="" tptype="admin_avatar" src="/eyoucms/public/static/admin/images/admint.png" style="cursor: pointer;"> </span><i class="arrow" id="admin-manager-btn" title="显示快捷管理菜单"></i>
