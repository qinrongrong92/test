<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/template/admin\login.htm";i:1547600098;s:63:"E:\www\www\eyoucms\application\admin\template\public\footer.htm";i:1545615936;}*/ ?>
<!DOCTYPE html>
...
<html>
    <head>
        ...
        <link href="/eyoucms/public/static/admin/css/login.css" rel="stylesheet" type="text/css" />
        <script type="text/javascript" src="/eyoucms/public/static/admin/js/jquery.js"></script>
        <script type="text/javascript" src="/eyoucms/public/static/admin/js/jquery.SuperSlide.2.1.2.js"></script>
    ...
    <body>
        ...
        <div class="container">
            <div class="logo">
                ...
                <img src="/eyoucms/public/static/admin/images/logo_ey.png?v=<?php echo time(); ?>">
                <?php else: ?>
                <img src="/eyoucms/public/static/admin/images/logo.png?v=<?php echo time(); ?>">
                <?php endif; ?>
            </div>
            <div class="box">
                <form action="" name='theForm' id="theForm" method="post">
                    ...
                    <div class="formText" style="position:relative">
                        ...
                        <img src="<?php echo U('Admin/vertify'); ?>" class="chicuele" id="imgVerify" alt="" onclick="fleshVerify();" style="position:absolute; right: 3px;top: 3px;height: 36px;">
                    </div>
                    <?php endif; ?>
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $('#theForm input[name=submit]').on('click',function(){
                    ...
                    if(vertify && $('#theForm input[name=username]').val() != '' && $('#theForm input[name=password]').val() != ''){
                        var url = "<?php echo U('Admin/login'); ?>";
                        if (url.indexOf('?') > -1) {
                            url += '&';
                        } else {
                            url += '?';
            ...
            function fleshVerify(){
                var src = "<?php echo U('Admin/vertify'); ?>";
                if (src.indexOf('?') > -1) {
                    src += '&';
                } else {
                    src += '?';
