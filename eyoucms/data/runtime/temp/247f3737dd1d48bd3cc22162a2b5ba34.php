<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:50:"./application/admin/template/filemanager\index.htm";i:1545616313;s:63:"E:\www\www\eyoucms\application\admin\template\public\layout.htm";i:1547521060;s:63:"E:\www\www\eyoucms\application\admin\template\public\footer.htm";i:1545615936;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="flexigrid">
                            ...
                            <td class="">
                                <div class="w120 tc">
                                  <?php if($vo['filemine'] == 'image'): if(in_array($vo['filetype'], $replaceImgOpArr)): if(is_check_access(CONTROLLER_NAME.'@replace_img') == '1'): ?>
                                        <a href="<?php echo U('Filemanager/replace_img',array('filename'=>$vo['filename'], 'activepath'=>replace_path(dirname($vo['filepath'])))); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>替换</a>
                                        <?php endif; endif; else: if(in_array($vo['filetype'], $editOpArr)): if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>
                                        <a href="<?php echo U('Filemanager/edit',array('filename'=>$vo['filename'], 'activepath'=>replace_path(dirname($vo['filepath'])))); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a href="<?php echo U('Filemanager/newfile', array('activepath'=>replace_path($activepath))); ?>">
