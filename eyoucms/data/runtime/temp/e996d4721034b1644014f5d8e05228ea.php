                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td class="">
                                <div class="w100 tc">
                                    <?php if($vo['target'] == '1'): ?>
                                        <span class="yes" <?php if(is_check_access('Links@edit') == '1'): ?>onClick="changeTableVal('links','id','<?php echo $vo['id']; ?>','target',this);"<?php endif; ?>><i class="fa fa-check-circle"></i>是</span>
                                    <?php else: ?>
                                        <span class="no" <?php if(is_check_access('Links@edit') == '1'): ?>onClick="changeTableVal('links','id','<?php echo $vo['id']; ?>','target',this);"<?php endif; ?>><i class="fa fa-ban"></i>否</span>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td class="">
                            ...
                            <td class="sort">
                                <div class="w60 tc">
                                    <?php if(is_check_access('Links@edit') == '1'): ?>
                                    <input style="text-align: left;" type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'');" onpaste="this.value=this.value.replace(/[^\d]/g,'');" onchange="changeTableVal('links','id','<?php echo $vo['id']; ?>','sort_order',this);" size="4"  value="<?php echo $vo['sort_order']; ?>" />
                                    <?php else: ?>
