<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:34:"./template/pc/\lists_guestbook.htm";i:1545616464;s:24:"./template/pc/header.htm";i:1545615936;s:22:"./template/pc/left.htm";i:1557373699;s:24:"./template/pc/footer.htm";i:1545615936;}*/ ?>
...
<script src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $_value = $tagGlobal->getGlobal("web_templets_pc"); echo $_value; ?>/skin/js/jquery.tips.js"></script>
</head>
<body>
<!--页头开始-->
    ...
    <div class="content"> 
      ...
      <div class="c-show">
        <div class="c-proBox">
          ...
          <div class="c-cb"> <?php  $typeid = ""; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagGuestbookform = new \think\template\taglib\eyou\TagGuestbookform; $_result = $tagGuestbookform->getGuestbookform($typeid, "default"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 2 );$i= intval($key) + 1;?>
            <form class="c-book form_book" method="POST" enctype="multipart/form-data" action="<?php echo $field['action']; ?>">
              <ul class="c-cbli">
                <li><em>姓名</em>
                  <input type="text" name="<?php echo $field['attr_4']; ?>" data-rule="姓名:required;">
                </li>
                <li><em>电话</em>
                  <input type="text" name="<?php echo $field['attr_5']; ?>" data-rule="电话:required;mobile|tel">
                </li>
                <li><em>地址</em>
                  <input type="text" name="<?php echo $field['attr_9']; ?>" data-rule="地址:required;">
                </li>
                <li><em>性别</em>
                  <select name="<?php echo $field['attr_7']; ?>">
                    
                    
                  <?php if(is_array($field['options']) || $field['options'] instanceof \think\Collection || $field['options'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $field['options'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $mod = ($e % 2 );$i= intval($key) + 1;?>
                ...
                <li><em>内容</em>
                  <textarea name="<?php echo $field['attr_6']; ?>" data-rule="留言内容:required;"></textarea>
                </li>
                <li class="bnt">
