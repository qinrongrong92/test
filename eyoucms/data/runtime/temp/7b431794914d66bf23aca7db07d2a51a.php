<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:32:"./template/pc/\lists_article.htm";i:1545616464;s:24:"./template/pc/header.htm";i:1545615936;s:22:"./template/pc/left.htm";i:1557373699;s:24:"./template/pc/footer.htm";i:1557564317;}*/ ?>
...
<div class="product sub_pro"> <div class="sub_pro01"> 
  ...
  <div class="product02">
    ...
    <div class="content">
      <ul class="news1">
        <?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result = $tagList->getList($param, 15, "", "", "desc");if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result["list"]; $__PAGES__ = $_result["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$field["title"] = text_msubstr($field["title"], 0, 50, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$mod = ($e % 2 );$i= intval($key) + 1;?>
        <li><a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>" class="pg-color" ><?php echo $field['title']; ?></a><span><?php echo MyDate('Y-m-d',$field['add_time']); ?></span></li>
        <?php ++$e; $aid = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; ?>
      </ul>
      <!--分页样式-->
      <div class="pagination-wrapper">
        <div class="pagination">  <?php  $__PAGES__ = isset($__PAGES__) ? $__PAGES__ : ""; $tagPagelist = new \think\template\taglib\eyou\TagPagelist; $_value = $tagPagelist->getPagelist($__PAGES__, "index,end,pre,next,pageno", "5"); echo $_value; ?> </div>
      </div>
    </div>
    <!--文章列表结束--> 
  </div>
