<?php /*a:1:{s:75:"D:\wamp64\www\tp5.1\application/admin/view\administrator\administrator.html";i:1557815592;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	<div id="table">
		<div class="return-title">
			...
			<a data-id="return">骑手管理</a data-ia>  -->
				...
				<form class="edit-form">
					<div class="edit-padding">
						...
						<div class="edit-input">
							<input type="text" v-model="editDetail.username" name="username" value="" placeholder="administrator" disabled="disabled">
						</div>
					</div>
			<!-- 		<div class="edit-padding">
						<div class="edit-title">
						...
						<div class="edit-input">
							<input type="text" v-model="editDetail.name" name="name" value="" placeholder="administrator" >
						</div>
					</div> -->
					<div class="edit-padding">
						<div class="edit-title">
						...
						<div class="edit-input">
							<select v-model="editDetail.status" name="status" value=""> 
			...
			<div class="status-edit">
				...
				<form action="" class="edit-form">
					...
					<div class="edit-padding">
						...
						<div class="edit-input">
							<input type="password" v-model="tableData.password" name="password" value="" placeholder="请输入密码">
						</div>
					</div>
					<div class="edit-padding">
						<div class="edit-title">
						...
						<div class="edit-input">
							<select v-model="tableData.status" name="status" value="">    <option disabled value="">请选择状态</option> 
								<option name="status" value='1'>正常</option> 
								<option name="status" value='2'>锁定</option> 
								<option name="status" value='3'>冻结</option> 
							</select> 
...
<script type="text/javascript">
	...
	var app = new Vue({
		...
		data:{
		    editlist: false,
		    addlist:false,
	   		tableData:{"id":0,"username":"","status":""},
		    editDetail: {},
		    searchVal:'',
		    pagesize: 10,
            curpage:1,
	    ...
	    methods: {
	      ...
	      //编辑
		    ...
		    update() {
		        ...
		        for(let i = 0; i < _this.newList.length; i++) {
		          if(_this.newList[i].id ==this.editid) {
		            _this.newList[i] = {
		              username:_this.editDetail.user,
		            ...
		            $.ajax({
						    type: "post",
						    url:  "/admin/administrator/administrator_edit",
						    contentType: "application/json; charset=utf-8",
			...
			deletelist(item) {
			    ...
			    $.ajax({
					    type: "get",
					    url:  "/admin/administrator/administrator_delete?id="+id,
					    contentType: "application/json; charset=utf-8",
					    dataType: "json",
					    success: function (data) {
					       if(data == 1)
			...
			search() {
				...
				document.getElementById('search').href="../administrator/administrator?username="+username
			},
      		 //上一页方法
